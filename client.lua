                    ...
                    options = {
                        {
                            ...
                            label = 'Rent Vehicle',
                            action = function()
                                TriggerEvent('droofis-rentals:client:rentVehicle', k)
                            end
...
RegisterNetEvent('droofis-rentals:client:rentVehicle', function(k)
        ...
        if location == k then 
            for vehicle, details in pairs(info.vehicles) do 
                table.insert(menu_options, {
                    ...
                    onSelect = function()
                        TriggerServerEvent('droofis-rentals:server:MoneyAmounts', vehicle, details.price, location)
                    end
                })
            end
        end
...
RegisterNetEvent('droofis-rentals:client:SpawnVehicle', function(vehiclename, location)
    ...
    TriggerServerEvent('droofis-rentals:server:RentVehicle', vehiclename, plate)
