...
RegisterNetEvent('droofis-rentals:server:RentVehicle', function(vehicle, plate)
    local src = source
...
RegisterNetEvent('droofis-rentals:server:MoneyAmounts', function(vehiclename, price, location)
    local src = source
    ...
    TriggerClientEvent('droofis-rentals:client:SpawnVehicle', src, vehiclename, location)
end)